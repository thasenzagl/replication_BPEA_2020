...
%% Load the data
csv_in = strcat('data/spread_data.csv');
...
datetick('x', 'yyyy');
legend({'3-Month Commercial Paper Minus FEDFUNDS', 'GZ-Spread', 'GZ-Excess Bond Premium', 'Real GDP growth'}, 'Location', 'SouthEast', 'FontSize', 14)
set(gcf,'Position',[800 450 800 450])
printpdf(f, 'output/spreads_and_gdp');
