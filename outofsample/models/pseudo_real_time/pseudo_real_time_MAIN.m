...
%%
% This script runs a pseudo real time forecasting exercise on real GDP
% growth using quantile regressions. First we use the Fred-MD dataset and 
% a calendar of past release dates to construct a set of pseudo real time 
...
[P, target_last, DatesV, DD, name_vintage, StartVintage, EndVintage, Period, ReleasesMat, iSer, iSer_idx] = dfm_initial_settings(P, StartDate, EndDate);
