function  [C_new, R_new, A_new, Q_new, Z_0_new, V_0_new, loglik] = EMstep(y, A, ...
    ...
    % É COPIATO DA INITCOND_FPv2 - confrontare con VAR e riscrivere
    % correttamente - controllare ordine coefficienti in A post KF/KS
    ...
    for i = 1:n_b
        ...
        vecInd1 = [vecInd1; rp1+1:rp1+r_i*ppC];                                        % Default: 1,2,3,4,5
        vecInd2 = [vecInd2; rp1+1:rp1+rp];                                             % 1, .., p
    end
    ...
    A_tmp = EZZ_FB(1:n_b,:) * inv(EZZ_BB);
    e     = (EZZ(1:n_b,1:n_b) - A_tmp*EZZ_FB(1:n_b,:)') / T;
    ...
    A_new(startInd_A(:), range_A)       = A_tmp;
    Q_new(startInd_A(:), startInd_A(:)) = e;
