...
namespace condhet_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "D:/Dropbox/research/Projects/SP20_BPEA/Code/estim/condhet.stan");
    reader.add_event(38, 36, "end", "D:/Dropbox/research/Projects/SP20_BPEA/Code/estim/condhet.stan");
    return reader;
}

class condhet_model
  : public stan::model::model_base_crtp<condhet_model> {
private:
        int T;
        int q;
        int p;
        ...
        matrix_d X;
public:
    condhet_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "condhet_model_namespace::condhet_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "condhet_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef condhet_model_namespace::condhet_model stan_model;
